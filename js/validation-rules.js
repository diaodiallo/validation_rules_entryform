Drupal.behaviors.myBehavior = {
    attach: function (context, settings) {
        ...
        */
            ...
            jQuery("#" + val.ind1).on("focusout", function () {
                ...
                if (!isNaN(val2)) {
                    if (!comparator(val1, val2, val.operator)) {
                        //The save button : Disable
                        // if (!jQuery(".button.button--primary.js-form-submit.form-submit").prop('disabled')) {
                        //     jQuery(".button.button--primary.js-form-submit.form-submit").prop('disabled', true);
                        // }
                        ...
                        //     jQuery(".button.button--primary.js-form-submit.form-submit").prop('disabled', false);
                        // }
                    }
                }
            });
        ...
        //On submit
        jQuery("#node-tajikistan-data-entry-form").submit(function() {
            if (jQuery("span").hasClass("validationMessage")) {
                //Change value
                //console.log("On submit: Not valid");
